...
export default function Home() {
    return (
        // HOME
        <div>
            <div className=" flex justify-between bg-[url('/img/bg.jpg')] bg-no-repeat bg-cover rounded-b-[50px]">
                <div className="font-bold text-white pt-36 w-[50%] pl-12 translate-x-6">
                    <p className="font-black text-4xl text-text">
                        "Get ready to fall in love, one slice at a time—because at
                        <span className="text-white">Saucy Sal’s</span>, every pizza is a
                        masterpiece made just for you!"
                    </p>
